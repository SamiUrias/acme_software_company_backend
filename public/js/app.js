...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", staticStyle: { border: "1px solid red" } },
    [
      _c(
        "nav",
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app',
  store: _stores_index__WEBPACK_IMPORTED_MODULE_4__["default"],
  router: new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"](_routes__WEBPACK_IMPORTED_MODULE_2__["default"]),
  render: function render(h) {
    return h(_views_App__WEBPACK_IMPORTED_MODULE_5__["default"]);
  }
});
...
var Home = function Home() {
  return __webpack_require__.e(/*! import() */ 7).then(__webpack_require__.bind(null, /*! ./components/Home */ "./resources/js/components/Home.vue"));
};

var About = function About() {
  return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ./components/About */ "./resources/js/components/About.vue"));
};

var NotFound = function NotFound() {
  return __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ./components/NotFound */ "./resources/js/components/NotFound.vue"));
};

var SingIn = function SingIn() {
  return __webpack_require__.e(/*! import() */ 8).then(__webpack_require__.bind(null, /*! ./components/SignIn */ "./resources/js/components/SignIn.vue"));
};
...
/* harmony import */ var _components_functions_cookieFunctions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/functions/cookieFunctions */ "./resources/js/components/functions/cookieFunctions.js");
  ...
  actions: {
    logout: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var state, commit, getters, headers;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                headers = {
                  'Content-Type': 'application/json',
                  'Authorization': "Bearer ".concat(getters.authToken)
                };
                console.log(headers.Authorization);
                _context.next = 7;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8000/api/logout', '', {
                  headers: headers
                }).then(function (response) {
                  console.log(response);
                  Object(_components_functions_cookieFunctions__WEBPACK_IMPORTED_MODULE_4__["eraseCookie"])('acmet');
                  state.auth_token = '';
  ...
  getters: {
    authToken: function authToken(state) {
      if (state.auth_token) {
        ...
        return Object(_components_functions_cookieFunctions__WEBPACK_IMPORTED_MODULE_4__["getCookie"])('acmet');
      }
    }
  }
}));
...
__webpack_require__(/*! /home/rootmaster/code/bluecoding_test/backend/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/rootmaster/code/bluecoding_test/backend/resources/sass/app.scss */"./resources/sass/app.scss");
